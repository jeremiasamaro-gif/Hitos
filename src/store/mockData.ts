...
export const mockExpenses: Expense[] = [
  ...
  { id: 'exp-1', project_id: PROJECT_ID, budget_item_id: 'bi-1-1', date: '2026-01-15', provider: 'Excavaciones del Sur', detail: 'Excavación completa', amount_ars: 4200000, amount_usd: 2896.55, exchange_rate: 1450, payment_method: 'transferencia', week_number: 3, created_by: ARQ_ID, created_at: '2026-01-15T10:00:00Z', updated_at: '2026-01-15T10:00:00Z' },
  { id: 'exp-2', project_id: PROJECT_ID, budget_item_id: 'bi-1-2', date: '2026-01-22', provider: 'Excavaciones del Sur', detail: 'Relleno y compactación', amount_ars: 2100000, amount_usd: 1448.28, exchange_rate: 1450, payment_method: 'transferencia', week_number: 4, created_by: ARQ_ID, created_at: '2026-01-22T10:00:00Z', updated_at: '2026-01-22T10:00:00Z' },
  { id: 'exp-3', project_id: PROJECT_ID, budget_item_id: 'bi-1-3', date: '2026-01-29', provider: 'Transportes Ruiz', detail: 'Retiro sobrante 10 viajes', amount_ars: 1900000, amount_usd: 1310.34, exchange_rate: 1450, payment_method: 'efectivo', week_number: 5, created_by: ARQ_ID, created_at: '2026-01-29T10:00:00Z', updated_at: '2026-01-29T10:00:00Z' },
  // Estructura — 28.750.000
  { id: 'exp-4', project_id: PROJECT_ID, budget_item_id: 'bi-2-1', date: '2026-02-03', provider: 'Hormigonera Central', detail: 'Hormigón para fundaciones', amount_ars: 9500000, amount_usd: 6551.72, exchange_rate: 1450, payment_method: 'transferencia', week_number: 6, created_by: ARQ_ID, created_at: '2026-02-03T10:00:00Z', updated_at: '2026-02-03T10:00:00Z' },
  { id: 'exp-5', project_id: PROJECT_ID, budget_item_id: 'bi-2-2', date: '2026-02-10', provider: 'Hierros Mendoza', detail: 'Hierro para columnas y vigas', amount_ars: 8500000, amount_usd: 5862.07, exchange_rate: 1450, payment_method: 'transferencia', week_number: 7, created_by: ARQ_ID, created_at: '2026-02-10T10:00:00Z', updated_at: '2026-02-10T10:00:00Z' },
  { id: 'exp-6', project_id: PROJECT_ID, budget_item_id: 'bi-2-2', date: '2026-02-17', provider: 'Encofrados SRL', detail: 'Encofrado y mano de obra columnas', amount_ars: 5750000, amount_usd: 3965.52, exchange_rate: 1450, payment_method: 'cheque', week_number: 8, created_by: ARQ_ID, created_at: '2026-02-17T10:00:00Z', updated_at: '2026-02-17T10:00:00Z' },
  { id: 'exp-7', project_id: PROJECT_ID, budget_item_id: 'bi-2-4', date: '2026-02-24', provider: 'Hormigonera Central', detail: 'Hormigón losa + bomba', amount_ars: 5000000, amount_usd: 3448.28, exchange_rate: 1450, payment_method: 'transferencia', week_number: 9, created_by: ARQ_ID, created_at: '2026-02-24T10:00:00Z', updated_at: '2026-02-24T10:00:00Z' },
  // Albañilería — 15.300.000
  { id: 'exp-8', project_id: PROJECT_ID, budget_item_id: 'bi-3-1', date: '2026-03-03', provider: 'Corralón El Constructor', detail: 'Ladrillos huecos 18x18x33', amount_ars: 7500000, amount_usd: 5172.41, exchange_rate: 1450, payment_method: 'transferencia', week_number: 10, created_by: ARQ_ID, created_at: '2026-03-03T10:00:00Z', updated_at: '2026-03-03T10:00:00Z' },
  { id: 'exp-9', project_id: PROJECT_ID, budget_item_id: 'bi-3-1', date: '2026-03-05', provider: 'Cuadrilla García', detail: 'Mano de obra mampostería', amount_ars: 4800000, amount_usd: 3310.34, exchange_rate: 1450, payment_method: 'efectivo', week_number: 10, created_by: ARQ_ID, created_at: '2026-03-05T10:00:00Z', updated_at: '2026-03-05T10:00:00Z' },
  { id: 'exp-10', project_id: PROJECT_ID, budget_item_id: 'bi-3-2', date: '2026-03-10', provider: 'Corralón El Constructor', detail: 'Cemento, cal, arena para revoques', amount_ars: 3000000, amount_usd: 2068.97, exchange_rate: 1450, payment_method: 'transferencia', week_number: 11, created_by: ARQ_ID, created_at: '2026-03-10T10:00:00Z', updated_at: '2026-03-10T10:00:00Z' },
  // Instalaciones — 12.100.000
  { id: 'exp-11', project_id: PROJECT_ID, budget_item_id: 'bi-4-1', date: '2026-03-01', provider: 'Electricidad Rodríguez', detail: 'Materiales eléctricos + cableado', amount_ars: 7200000, amount_usd: 4965.52, exchange_rate: 1450, payment_method: 'transferencia', week_number: 9, created_by: ARQ_ID, created_at: '2026-03-01T10:00:00Z', updated_at: '2026-03-01T10:00:00Z' },
  { id: 'exp-12', project_id: PROJECT_ID, budget_item_id: 'bi-4-2', date: '2026-03-08', provider: 'Sanitarios López', detail: 'Caños, conexiones, tanque', amount_ars: 4900000, amount_usd: 3379.31, exchange_rate: 1450, payment_method: 'transferencia', week_number: 10, created_by: ARQ_ID, created_at: '2026-03-08T10:00:00Z', updated_at: '2026-03-08T10:00:00Z' },
  // Terminaciones — 5.200.000
  { id: 'exp-13', project_id: PROJECT_ID, budget_item_id: 'bi-5-1', date: '2026-03-12', provider: 'Cerámica San Lorenzo', detail: 'Pisos porcellanato 60x60', amount_ars: 5200000, amount_usd: 3586.21, exchange_rate: 1450, payment_method: 'transferencia', week_number: 11, created_by: ARQ_ID, created_at: '2026-03-12T10:00:00Z', updated_at: '2026-03-12T10:00:00Z' },
  // Aberturas — 2.800.000
  { id: 'exp-14', project_id: PROJECT_ID, budget_item_id: 'bi-6-1', date: '2026-03-14', provider: 'Aluminios Cuyo', detail: 'Seña ventanas DVH (4 unidades)', amount_ars: 2800000, amount_usd: 1931.03, exchange_rate: 1450, payment_method: 'transferencia', week_number: 11, created_by: ARQ_ID, created_at: '2026-03-14T10:00:00Z', updated_at: '2026-03-14T10:00:00Z' },
]
